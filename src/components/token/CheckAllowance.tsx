...
export default function CheckAllowance() {
  ...
  return (
    isConnected && (
      <Card className="w-full max-w-md h-[65dvh] mx-auto my-8 backdrop-blur-md bg-white/90 shadow-xl border border-gray-200/50 rounded-2xl overflow-hidden hover:shadow-cyan-500/20 transition-all duration-300">
